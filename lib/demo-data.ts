...
export const recommendedProjects: Project[] = [
  {
    ...
    title: "대외계 API 고도화",
    client: "KB 계열사",
    summary: "MCI 연계 API 구축·운영",
    description: "금융권 대외계 API를 Spring 기반으로 고도화하고 Oracle 운영 쿼리를 개선합니다.",
    fit: 92,
    tags: ["금융권", "API", "MCI", "Java", "Spring", "Oracle"],
    rate: "월 850~950",
    location: "여의도",
    workType: "주 3일 상주",
    period: "6개월",
  ...
  },
  {
    ...
    title: "주문/정산 백엔드",
    client: "리테일 스타트업",
    summary: "정산 API와 데이터 흐름 구축",
    description: "커머스 주문과 정산 도메인의 백엔드 API를 구축하고 PostgreSQL 기반 데이터를 정리합니다.",
    fit: 84,
    tags: ["커머스", "API", "Node.js", "PostgreSQL", "AWS"],
    rate: "월 750~850",
    location: "판교",
    workType: "원격 가능",
    period: "4개월",
    reasons: ["정산 도메인 유사", "PostgreSQL 경험", "즉시 투입 가능"]
  },
  {
    id: "insurance-mobile",
    title: "보험 모바일 웹 리뉴얼",
    client: "대형 보험사",
    summary: "가입 플로우 모바일 최적화",
    description: "보험 가입 플로우를 모바일 웹 기준으로 재구성하고 Next.js 화면 성능을 개선합니다.",
    fit: 78,
    tags: ["보험", "모바일", "React", "Next.js", "TypeScript"],
    rate: "월 700~820",
    location: "을지로",
    workType: "주 2일 상주",
    period: "5개월",
