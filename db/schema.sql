...
create table public.skill_normalizations (
...
insert into public.skill_normalizations (canonical, label, aliases) values
  ('spring_boot', 'Spring Boot', '{springboot,"spring boot",스프링부트}'),
  ('spring', 'Spring', '{spring,스프링}'),
  ('java', 'Java', '{java,자바}'),
  ('oracle', 'Oracle', '{oracle,오라클}'),
  ('api', 'API', '{api,"rest api",인터페이스}'),
  ('mci', 'MCI', '{mci,대외계,채널계}')
